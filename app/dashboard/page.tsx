        ...
        <div className="flex h-full">
          ...
          {mobileNavOpen && (
            <>
              ...
              {/* Bottom Nav Bar */}
              <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden pb-safe animate-slideUp">
                <div className="bg-[#1a1a1a]/95 border-t border-[#2a2a2a] backdrop-blur-xl shadow-2xl p-3 mx-4 mb-4 rounded-2xl">
                  <div className="flex items-center justify-around max-w-md mx-auto">
                    <button
                      onClick={() => { setActiveView('ideas'); setMobileNavOpen(false); }}
                      className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-colors ${
                        activeView === 'ideas' ? 'text-blue-400 bg-blue-500/10' : 'text-slate-400'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-colors ${
                        activeView === 'allIdeas' ? 'text-blue-400 bg-blue-500/10' : 'text-slate-400'
                      }`}
                    >
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-colors ${
                        activeView === 'domains' ? 'text-blue-400 bg-blue-500/10' : 'text-slate-400'
                      }`}
                    >
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-colors ${
                        activeView === 'thisMonth' ? 'text-blue-400 bg-blue-500/10' : 'text-slate-400'
                      }`}
                    >
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
