          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.step} className="relative">
                <div className="p-6 rounded-2xl bg-[#1a1a1a]/20 border border-[#2a2a2a]/30 backdrop-blur-2xl text-center hover:shadow-lg hover:shadow-blue-500/10 transition-all hover:-translate-y-1">
