        ...
        <div className="flex h-full">
          ...
          {mobileNavOpen && (
            <>
              ...
              {/* Floating Nav Card */}
              <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 z-40 lg:hidden animate-scaleIn">
                <div className="bg-[#1a1a1a]/95 border border-[#2a2a2a] rounded-3xl backdrop-blur-xl shadow-2xl p-6 max-w-sm mx-auto">
